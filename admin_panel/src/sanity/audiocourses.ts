...
export const AudioCourse = defineType({
  name: 'audioCourse',
  title: 'Audio Courses',
  type: 'document',
  fields: [
    defineField({
      ...
      description: 'The name of the audio course.',
    }),
    defineField({
      name: 'image',
      title: 'Course Image',
      ...
      description: 'An image representing the audio course.',
    }),
    defineField({
      name: 'dateRange',
      title: 'Date Range',
      type: 'object',
      description: 'Optional start and end dates for the audio course.',
      fields: [
        defineField({
          name: 'startDate',
          title: 'Start Date',
    ...
    defineField({
      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({
              ...
              title: 'Lesson Audio',
              type: 'file',
              description: 'Upload an audio file for the lesson.',
              validation: (Rule) => Rule.required(),
            }),
            defineField({
              name: 'publishedDate',
      ...
      description: 'An optional list of lessons for the audio course.',
    }),
  ],
});